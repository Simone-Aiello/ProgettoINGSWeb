...
<html>
	<head>
		...
		<script src="/js/cards/advertiseCard.js"></script>
		<link rel="stylesheet" href="/css/common.css">
    	<script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.9.1/gsap.min.js" integrity="sha512-H6cPm97FAsgIKmlBA4s774vqoN24V5gSQL4yBTDOY2su2DeXZVhQPxFK4P6GPdnZqM9fg1G3cMv5wD7e6cFLZQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    	<script src="/js/cards/advertiseCard.js"></script>
   		<script src="/js/cards/offerCardForm.js"></script>
				...
				<c:forEach items="${advertises}" var = "advertise">
						<script type="text/javascript">
							console.log("${advertise.getTitle()}");
						 	card = createCard({
						 	    id_advertise : ${advertise.getId()} , 
						 	    title : "${advertise.getTitle()}",
						 	    description : "${advertise.getDescription()}",
						 	    username_client : "${advertise.getAccount().getUsername()}",
						 	    province : "${advertise.getProvince()}",
						 	    date : "${advertise.getExpiryDate()}",
						 	    url_img : "../images/testImage.png" ,
						 	    }) ; 
						 	card.id = 'card-'+i;
							ads.append(card);
							document.getElementById('card-'+i).show();
						 i = i+1;
						</script>
				</c:forEach>
			</div>
